export const chinese: Record<string, string> = {
  ...
  'Créez des créatures procédurales dans votre navigateur. Tout reste local.':
    '在浏览器中创建程序化生物。一切数据都保留在本地。',
  'Ouvrir le Studio': '打开工作室',
